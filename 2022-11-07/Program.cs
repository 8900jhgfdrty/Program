...
namespace RecruitingAgency
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Data data = new Data(); //Initializing the Data structure,初始化数据结构
            data.salary = new int[lineLength]; // 从数据结构中设置阵列的长度
            data.month = new int[lineLength];
            data.name = new string[lineLength];
            //从控制台读取数据到结构中，并进行前提条件输入检查，然后返回结构。
       ...
       // 打印出数据结构中的数据
        ...
        //creates a list of the people and their overall sallary 22
